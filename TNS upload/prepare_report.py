...
class Options(object):
    def __init__(self, **kwargs):
        ...
        self.reporter = self._getvalue(kwargs, "reporter",
                                       default_value="C. Fremling (Caltech), K. Taggart (LJMU) on behalf of the Zwicky Transient Facility (ZTF) collaboration")
...
class TNSClient(object):
    ...
    def send_bulk_report(self):
        ...
        with open('json_reports_for_sending/data.txt', 'w') as outfile:
...
def report(internal_name, ra, dec, mag, mag_err,lim_mag,time_lim, filter_name,filt_lim, obsdate, time_last, mag_last, filt_last, magerr_last):
